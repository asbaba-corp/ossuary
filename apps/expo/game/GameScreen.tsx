  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <View style={styles.hud}>
        <Metric label="ONDA" value={vm.waveLabel} />
        <Metric label="OURO" value={String(vm.gold)} />
        <Metric label="ABATES" value={String(vm.runKills)} />
      ...
      <SceneRenderer
        ...
        enemies={enemies.map(({ snapshot, hp }) => ({ id: snapshot.id, name: snapshot.name, hp, maxHp: snapshot.stats.maxHp }))}
      />
      ...
      <View style={styles.ledger}>
        <Metric label="LOOT" value={`+${vm.state?.run?.metrics?.loot ?? vm.runIncome}`} />
        <Metric label="GASTO EM POÇÕES" value={String(vm.runExpenses)} />
        <Metric label="SALDO DA RUN" value={String(vm.runIncome - vm.runExpenses)} />
        <Metric label="ABATES" value={String(vm.runKills)} />
        <Metric label="POEIRA" value={String(vm.runDust)} />
        <Metric label="RECUOS" value={String(vm.runRetreats)} />
      </View>
